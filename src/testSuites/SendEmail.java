...
public class SendEmail {
	...
	public static void main(String[] args) {  
        ...
        Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {  
            ...
            return new PasswordAuthentication("1397913243@qq.com", "brwaaukxhdubghej");  
        ...
        try {  
            ...
            // 设置发件人邮箱地址  
            message.setFrom(new InternetAddress("1397913243@qq.com"));  
   
            // 设置收件人邮箱地址  
            message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("1397913243@qq.com"));  
